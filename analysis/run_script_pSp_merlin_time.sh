...
echo "    \"simlength\": [100000,10000,5000000]," >> SimParamFiles/simparams${suffix}msd.json
...
echo "    \"tau\": 0.035" >> AnaParamFiles/anaparams${suffix}msd.json
echo "}" >> AnaParamFiles/anaparams${suffix}msd.json


echo "{" >> SimParamFiles/simparams${suffix}geom.json
echo "    \"simlength\": [10000,100000,2500000]," >> SimParamFiles/simparams${suffix}geom.json
...
echo "    \"intermingling\": [0,\"HiC_dir/\",1,0.5,0.5]," >> AnaParamFiles/anaparams${suffix}geom.json
...
echo "    \"IntensityMap\": [1,\"Intensity_dir/\",0.4,${ella},${ellb},${ellc},8]," >> AnaParamFiles/anaparams${suffix}geom.json
...
#
python3 run_conf_analysis.py AnaParamFiles/anaparams${suffix}msd.json SimParamFiles/simparams${suffix}msd.json
