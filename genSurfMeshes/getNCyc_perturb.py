...
for m in range(len(modifications)):
    ...
    coms,tris,indices = get_new_points_tris(modsurfpoints,nsurf,surfrad,
                                            sfneighfact,ella,ellb,ellc,mod)
    ...
    #### write this to file
    name = conffile[:-4] +"_"+str(mod[0]*ella)+"_"+str(mod[1]*ellb)+"_"+str(mod[2]*ellc)+"_ovito.dat"
    ...
    #### write this to file
    name = conffile[:-4] +"_"+str(mod[0]*ella)+"_"+str(mod[1]*ellb)+"_"+str(mod[2]*ellc)+"_undeform_ovito.dat"
...
#### write this to file
name = conffile[:-4] +"_"+str(mod[0]*ella)+"_"+str(mod[1]*ellb)+"_"+str(mod[2]*ellc)+"_final_ovito.dat"
